from . import auth
from .forms import RegisterForm, LoginForm, ChangePasswordForm, ChangeEmailForm, PasswordResetRequestForm, \
    PasswordResetForm
...
@auth.route('/change-email/<token>', methods=['POST', 'GET'])
@login_required
